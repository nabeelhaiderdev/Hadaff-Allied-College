...
if ( ! function_exists( 'glide_setup_function' ) ) {
	...
	function glide_setup_function() {
		...
		load_theme_textdomain( 'hdfall_td' );
		...
		register_nav_menus(
			array(
				'header-nav'   => __( 'Header Nav', 'hdfall_td' ),
				'footer-nav-one' => __( 'Footer Nav One', 'hdfall_td' ),
				'footer-nav-two' => __( 'Footer Nav Two', 'hdfall_td' ),
				'footer-nav-three' => __( 'Footer Nav Three', 'hdfall_td' ),
				'legal-nav' => __( 'Legal Nav', 'hdfall_td' ),
			)
		);
...
function glide_register_required_plugins() {
    ...
    $config = array(
        ...
        'strings'      => array(
            'page_title'                      => __( 'Install Required Plugins', 'hdfall_td' ),
            'menu_title'                      => __( 'Plugin Installer', 'hdfall_td' ),
            'installing'                      => __( 'Installing Plugin: %s', 'hdfall_td' ), // %s = plugin name.
            'oops'                            => __( 'Something went wrong with the plugin API.', 'hdfall_td' ),
            ...
            'return'                          => __( 'Return to Required Plugins Installer', 'hdfall_td' ),
            'plugin_activated'                => __( 'Plugin activated successfully.', 'hdfall_td' ),
            'complete'                        => __( 'All plugins installed and activated successfully. %s', 'hdfall_td' ), // %s = dashboard link.
...
class pgroup_menu_walker extends Walker_Nav_Menu
{
    ...
    function start_lvl(&$output, $depth = 0, $args = array(), $id = 0) {
        ...
        $output .= '<i class="fas fa-chevron-down drop-opener"></i><div class="nav-dropdown"><ul class="menu-col">';
    }
...
function pgroup_header_navigation() {
	...
	$args = array(
		...
		'container_id' => 'pgroup-navigation',
		'container' => 'div',
