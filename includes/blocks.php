...
function glide_theme_acf_init() {
	...
	acf_register_block(
		...
		acf_register_block(
			array(
				'name'            => 'text',
				'title'           => __( 'Text', 'hdfall_td' ),
				'description'     => __( 'A text.', 'hdfall_td' ),
				'render_callback' => 'glide_acf_block_callback',
				'category'        => 'glide-blocks',
				'icon'            => 'images-alt2',
				'mode'            => 'edit',
		...
		acf_register_block(
			array(
				...
				'title'           => __( 'Icons Alongside Text', 'hdfall_td' ),
				'description'     => __( 'A icons-alongside-text.', 'hdfall_td' ),
				'render_callback' => 'glide_acf_block_callback',
				'category'        => 'glide-blocks',
				'icon'            => 'images-alt2',
				'mode'            => 'edit',
				'keywords'        => array( 'icons-alongside-text' ),
				'align'           => 'wide',
				// calling assets js,css
				// 'enqueue_assets' => function(){
				// wp_enqueue_script( 'block-testimonial', get_template_directory_uri() . '/scripts/jquery.cycle2.min.js', array('jquery'), '', true );
		...
		acf_register_block(
			array(
				'name'            => 'logo',
				'title'           => __( 'Logo', 'hdfall_td' ),
				'description'     => __( 'A Logo.', 'hdfall_td' ),
				'render_callback' => 'glide_acf_block_callback',
				'category'        => 'glide-blocks',
				'icon'            => 'images-alt2',
				'mode'            => 'edit',
		...
		acf_register_block(
			array(
				'name'            => 'contact-form',
				'title'           => __( 'Contact Form', 'hdfall_td' ),
				'description'     => __( 'A Contact Form.', 'hdfall_td' ),
				'render_callback' => 'glide_acf_block_callback',
				'category'        => 'glide-blocks',
				'icon'            => 'images-alt2',
				'mode'            => 'edit',
