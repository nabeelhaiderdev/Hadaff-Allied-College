...
$hdfall_tblgho_feature_post 	= $fields['hdfall_tblgho_feature_post'];
$hdfall_author_avatar 		= $fields['hdfall_author_avatar'];
$hdfall_pagetitle = (isset($fields['hdfall_tblgho_title']) && $fields['hdfall_tblgho_title']!='' ) ? $fields['hdfall_tblgho_title'] : get_the_title();

// $categories=get_categories(array(
// 	'hide_empty' 	=> false,
// ));

$hdfall_post_catagories = get_categories($pID);
// var_dump($hdfall_post_catagories);
	...
	<div class="wrapper">
		...
		<div class="blog-nav">
			<div class="nav-ctn d-flex justify-content-center flex-wrap">
				<?php if($hdfall_post_catagories){ ?>
					<ul>
						<?php foreach ($hdfall_post_catagories as $category ) { ?>
		...
		<?php
		global $post;
		if($hdfall_tblgho_feature_post){ ?> <?php foreach ($hdfall_tblgho_feature_post as $key => $feature_post) {
			$post = $feature_post;
			setup_postdata( $post );
			$pID         = $post->ID;
			...
			$author_avatar = ($hdfall_author_avatar)? $hdfall_author_avatar : get_avatar_url($pID);
